---
title: "040 — Development & Contribution Guidelines"
category: "developers"
order: 40
...
This document outlines the coding standards, git workflow, and contribution guidelines for **Open Knowledge Studio v2.0**.
...
- **Never introduce new runtime dependencies** without evaluation against `docs/developers/100-dependency-removal.md` criteria.
...
### 3.4 Test Files (6 files, 74 total tests)

| File | Type | Count |
| :--- | :--- | :--- |
| `memory.unit.test.ts` | Memory unit tests | 25 cases |
| `memory.integration.test.ts` | Memory integration tests | 10 cases |
| `memory.benchmark.ts` | Performance benchmarks | 5 cases |
| `gemini.test.ts` | LLM provider router tests | 8 cases |
| `sandbox.test.ts` | Sandbox execution tests | 9 cases |
| `icd11.test.ts` | ICD-11 lookup tests | 22 cases |
...
- [Developer Guide: Setup & Installation](050-setup.md) — Environment setup and prerequisites
- [Developer Guide: Test Suite](080-test-suite.md) — Test architecture and coverage
- [Developer Guide: Code Splitting](095-code-splitting.md) — Performance optimization
- [Developer Guide: Dependency Removal](100-dependency-removal.md) — Zero-dependency rules
- [Project Reference](../project/100-reference.md) — API keys and configuration reference
