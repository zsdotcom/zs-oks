...
- [Developer Guide: Development](040-development.md) — Git workflow and PR guidelines
- [Developer Guide: Deployment](099-deployment.md) — Docker, Vercel, and Netlify guides
- [Project Reference](../project/100-reference.md) — Environment variables and secrets configuration
