---
title: "095 — Code Splitting & Performance"
category: "developers"
order: 95
tags: ["performance", "code-splitting", "lazy-loading", "optimization"]
...
- [Developer Guide: Development](040-development.md) — Zero dependency rule
- [Developer Guide: Dependency Removal](100-dependency-removal.md) — Full zero-dependency philosophy
- [Project Architecture](../project/020-architecture.md) — Component architecture overview
- [Project Reference](../project/100-reference.md) — Build configuration and metrics
