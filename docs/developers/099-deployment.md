---
title: "099 — Deployment"
category: "developers"
order: 99
tags: ["deployment", "docker", "vercel", "netlify", "devops"]
...
- [Developer Guide: Setup & Installation](050-setup.md) — Prerequisites and environment setup
- [Developer Guide: CI/CD Pipeline](098-cicd-pipeline.md) — GitHub Actions workflows
- [Project Reference](../project/100-reference.md) — Environment variables and configuration
