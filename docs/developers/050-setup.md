---
title: "050 — Setup & Installation Guide"
category: "developers"
order: 50
...
This document provides step-by-step instructions for setting up the **Open Knowledge Studio v2.0** development environment.
...
- [Developer Guide: Development](040-development.md) — Coding standards and contribution guidelines
- [Developer Guide: CI/CD Pipeline](098-cicd-pipeline.md) — GitHub Actions workflows
- [Developer Guide: Deployment](099-deployment.md) — Docker, Vercel, and Netlify guides
- [Project Reference](../project/100-reference.md) — API keys and environment variables reference
